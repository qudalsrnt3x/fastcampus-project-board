...
public class DataRestTest {
    ...
    @Test
    void givenNoting_whenRequestingCommentsFromArticle_thenReturnsCommentsJsonResponse() throws Exception {
        // given
    ...
    @Test
    void givenNoting_whenRequestingComment_thenReturnsCommentJsonResponse() throws Exception {
        // given

        // when & then
        mvc.perform(get("/api/comments/113"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.valueOf("application/hal+json")));
    }
