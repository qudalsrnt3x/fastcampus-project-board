...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "unoTest", setupBefore = TestExecutionEvent.TEST_EXECUTION) // TestSecurityConfig 정보를 가져옴
    ...
    @Test
    void given_whenRequestingArticleHashtagView_thenReturnsArticleHashTagView() throws Exception {
        // given
